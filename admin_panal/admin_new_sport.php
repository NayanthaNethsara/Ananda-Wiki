...
if (isset($name)) {
	if (!empty($name)) {
 	...
 	if (!empty($sname &&/* $catagory &&*/ $fname && $views)) {
 		...
 		$query = "INSERT INTO sports(sname, fname, views,  picture, catagory) VALUES ('{$sname}','{$fname}','{$views}', '{$picture}', 'sport')";
...
<form method="POST" enctype="multipart/form-data" >
		...
		<label>sport Name (SHORT FORM)</label> <input type="text" name="sname" maxlength="8">
		<br>
		<br>
